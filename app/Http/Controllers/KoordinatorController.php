...
class KoordinatorController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('DashboardKoordinator/index', [
            'title' => 'Dashboard',
    ...
    public function indexKasWarga(Request $request)
    {
        ...
        return Inertia::render('DashboardKoordinator/KasWarga', [
            'kas' => $kas,
            'saldoKas' => $saldoKas,
     ...
     public function indexKasRukem(Request $request)
{
    ...
    return Inertia::render('DashboardKoordinator/KasRukem', [
        'kas' => $kas,
        'saldoKas' => $saldoKas,
        'periodeList' => $periodeList,
        'selectedPeriode' => $selectedPeriode,
...
public function iuranPribadi(Request $request)
{
    ...
    return Inertia::render('DashboardKoordinator/IuranPribadi', [
        'auth' => ['user' => $user],
        'iuran' => $iuran,
        'total' => $total,
    ]);
...
public function profilSaya(Request $request)
{
    ...
    return Inertia::render('DashboardKoordinator/ProfilSaya', [
        'auth' => ['user' => $user],
        'warga' => $warga,
    ]);
}
...
public function listIuran()
    {
        ...
        return Inertia::render('DashboardKoordinator/list_iuran', [
            'iurans' => $iuran,
