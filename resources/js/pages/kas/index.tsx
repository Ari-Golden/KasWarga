                            ...
                            <Tabs defaultValue="General Kas" className="w-full">
                                ...
                                <TabsContent value="General Kas">
                                    <Card>
                                        ...
                                        <CardContent className="grid gap-6">
                                            <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
                                                <LaporanKasTable kasWarga={_.kasWargas || []} />
                                            </div>
                                        </CardContent>
                                        <CardFooter>
                                ...
                                <TabsContent value="Iuran Bulanan">
                                    <Card>
                                        ...
                                        <CardContent className="grid gap-6">
                                            ...
                                            {/* Tampilkan data iuran berdasarkan periode yang dipilih */}
                                            {selectedPeriode ? (
                                                (() => {
                                ...
                                <TabsContent value="Pemasukan Lain">
                                    <Card>
                                        ...
                                        <CardContent className="grid gap-6">Disini akan ditampilkan data pemasukan lain warga</CardContent>
                                        <CardFooter>
